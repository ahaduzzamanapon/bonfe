...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body { background:#fff; font-family:'Times New Roman',Times,serif; font-size:11pt; color:#000; }
        ...
        .header-org { font-size: 17pt; font-weight: bold; color: #006400; font-family:Arial,sans-serif; }
        .header-url { font-size: 9pt; color: #444; margin: 1px 0; }
        .header-title { font-size: 11.5pt; font-weight: bold; color: #8b0000; text-decoration: underline; margin-top: 2px; }

        /* ── TOP SECTION (occupation + photo) ── */
        .top-section { display:flex; align-items:flex-start; margin-top:7px; gap:8px; }
        .top-fields { flex:1; }
        .top-field-row { display:flex; align-items:flex-end; margin-bottom:6px; font-size:10.5pt; }
        .top-field-label { white-space:nowrap; font-weight:bold; }
        .top-field-line { flex:1; border-bottom:1px solid #000; margin-left:5px; font-weight:600; padding-bottom:1px; }
        ...
        .photo-box {
            ...
            flex-shrink:0; background:#f9f9f9; overflow:hidden;
        }
        .photo-box img { width:100%; height:100%; object-fit:cover; }
        .photo-label { font-size:8pt; color:#666; text-align:center; font-family:'Noto Serif Bengali',serif; padding:4px; }
        ...
        /* ── FIELDS ── */
        .field-row { display:flex; align-items:flex-end; margin-bottom:7px; min-height:20px; }
        .field-num { width:24px; font-size:10.5pt; flex-shrink:0; }
        .field-label { font-size:10.5pt; white-space:nowrap; flex-shrink:0; }
        .field-underline { flex:1; border-bottom:1px solid #000; margin-left:4px; font-size:10.5pt; font-weight:600; padding-bottom:1px; }
        .field-bn {
            margin-left:24px; font-family:'Noto Serif Bengali',serif;
            font-size:9.5pt; color:#333; margin-bottom:6px;
            display:flex; align-items:flex-end;
        }
        .field-bn-underline { flex:1; border-bottom:1px solid #000; margin-left:4px; font-size:10pt; font-weight:600; padding-bottom:1px; }

        /* Date boxes */
        .dob-row { display:flex; align-items:flex-end; gap:1px; margin-left:4px; }
        .dob-cell { border-bottom:1px solid #000; text-align:center; font-weight:600; font-size:10.5pt; }
        .dob-sep { font-size:10pt; padding:0 2px; }

        /* ── SIGNATURES ── */
        .signatures { display:flex; justify-content:space-between; margin-top:18px; }
        .sig-block { text-align:center; }
        .sig-line { border-top:1px solid #000; width:140px; margin:0 auto 2px auto; }
        .sig-label { font-size:10pt; }

        /* ── SECTION HEADER spacing ── */
        .section-header { margin: 10px 0 6px 0; }

        /* ── INSTRUCTIONS ── */
        .instructions { border:1px solid #000; margin-top:8px; padding:5px 8px; }
        .inst-title { font-weight:bold; font-size:10.5pt; text-align:center; text-decoration:underline; margin-bottom:4px; }
        .instructions ul { margin-left:16px; font-size:9pt; line-height:1.6; }

        .print-btn { display:block; margin:8px auto; padding:7px 22px; background:#006400; color:#fff; border:none; border-radius:4px; font-size:13px; cursor:pointer; }
    </style>
</head>
<body>
...
<div class="page">
    ...
    <div class="header">
        ...
        <div class="header-center">
            <div class="header-org">Non-Formal Education Board</div>
            <div class="header-url">www.bafe.gov.bd</div>
    ...
    <div class="field-row">
        ...
        <span class="field-label">NID Number/BRN:</span>
        <span class="field-underline">{{ $student->nid }}{{ $student->brn ? ' / '.$student->brn : '' }}</span>
    </div>

    <div class="field-row">
        <span class="field-num">06.</span>
        <span class="field-label">Address (ঠিকানা):</span>
        <span class="field-underline">{{ $student->address }}{{ $student->district_name ? ', '.$student->district_name : '' }}</span>
    </div>
    ...
    <div class="field-row">
        ...
        <span class="field-underline">{{ $student->assessment_center_name ?? $student->assessment_center }}</span>
    </div>
    ...
    <div class="instructions">
        ...
        <ul>
            ...
            <li>Photograph attached in this registration card will be matched with the candidate during the assessment</li>
            <li>NFEB reserves all rights to take any kind of punitive measure against any candidate who adopts unfair means or misconduct during the assessment</li>
            <li>No TA/DA will be admissible for attending the assessment</li>
            <li>This registration card will be considered as admit card for assessment</li>
        </ul>
