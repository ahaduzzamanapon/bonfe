                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <select id="dashboard_program" name="dashboard_program" class="form-control"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <select id="dashboard_occupation" name="dashboard_occupation" class="form-control"
                                onchange="fetchDashboardData()">
...
<section class="content">
    <div class="dashboard_cards_header">
        ...
        <div class="dashboard_card">
            <a href="{{ route('students.index') }}" style="text-decoration: none!important;" class="indexLink">
                <div class="custom-card ">
...
@section('footer_scripts')
    ...
    <script>
        function fetchDashboardData() {
            ...
            $('#total_absent_students').html('<div class="spinner-border" role="status"><span class="sr-only">Loading...</span></div>');
            $('#total_dropout_students').html('<div class="spinner-border" role="status"><span class="sr-only">Loading...</span></div>');
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#total_students').html(data.total_students ? data.total_students : 0);
                    $('#total_passed_students').html(data.total_passed_students ? data.total_passed_students : 0);
                    $('#total_failed_students').html(data.total_failed_students ? data.total_failed_students : 0);
                    $('#waiting_for_chairman').html(data.waiting_for_chairman ? data.waiting_for_chairman : 0);
                    $('#waiting_for_district').html(data.waiting_for_district ? data.waiting_for_district : 0);
                    $('#generated_certificate').html(data.generated_certificate ? data.generated_certificate : 0);
                    $('#waiting_for_assessment_center').html(data.waiting_for_assessment_center ? data.waiting_for_assessment_center : 0);
                    $('#waiting_for_assessment_controller').html(data.waiting_for_assessment_controller ? data.waiting_for_assessment_controller : 0);
                    $('#total_absent_students').html(data.total_absent_students ? data.total_absent_students : 0);
                    $('#total_dropout_students').html(data.total_dropout_students ? data.total_dropout_students : 0);
                    $('#program_type').html(data.program_type ? data.program_type : '');
